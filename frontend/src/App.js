...
import AdvancedSeedSearchPage from './pages/AdvancedSeedSearchPage';
import SeedBanksPage from './pages/SeedBanksPage';
      ...
      <BrowserRouter>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/seeds/search" element={<AdvancedSeedSearchPage />} />
            <Route path="/seeds/banks" element={<SeedBanksPage />} />
